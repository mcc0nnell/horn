...
class ClaimAtomicityBundleActivator final {
public:
    explicit ClaimAtomicityBundleActivator(const std::shared_ptr<celix::BundleContext>& ctx) {
        auto rule = horn::rules::createClaimAtomicityRule();
...
CELIX_GEN_CXX_BUNDLE_ACTIVATOR(ClaimAtomicityBundleActivator)
